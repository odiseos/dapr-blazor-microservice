...
public class FiveInLine
{
    ...
    public FiveInLine() : this(9, 9, 6, 5, 8)
    {
    ...
    private void Check5InLine(Position p)
    {
        ...
        //check up down
        Console.WriteLine("check up down");
        points += Check5InLine(p, 0, 1, 0, -1);
        //check right left
        Console.WriteLine("check right left");
        points += Check5InLine(p, 1, 0, -1, 0);
        //check right up left down
        Console.WriteLine("check right up left down");
        points += Check5InLine(p, 1, -1, -1, 1);
        //check right down left up
        Console.WriteLine("check right down left up");
        points += Check5InLine(p, -1, -1, 1, 1);
    }
